...
import org.gfs.chat.jobs.SendRetryReceiptJob
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [org.gfs.chat.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
