...
class MiscellaneousValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  /**
   * The last time we ran an account consistency check via [org.gfs.chat.jobs.AccountConsistencyWorkerJob]
   */
  ...
  /**
   * The last time we prompted the user regarding a [org.gfs.chat.util.ConnectivityWarning].
   */
