...
import org.gfs.chat.attachments.ArchivedAttachment
...
import org.gfs.chat.backup.v2.proto.BodyRange
...
import org.gfs.chat.backup.v2.proto.LinkPreview
...
import org.gfs.chat.database.ReactionTable
import org.gfs.chat.database.SQLiteDatabase
...
import org.gfs.chat.database.model.databaseprotos.CryptoValue
...
class ChatItemImportInserter(
  ...
  private fun LinkPreview.toLocalLinkPreview(): org.gfs.chat.linkpreview.LinkPreview {
    return org.gfs.chat.linkpreview.LinkPreview(
      this.url,
      this.title ?: "",
      this.description ?: "",
      this.date ?: 0,
