...
import org.gfs.chat.backup.v2.BackupRepository.getMediaName
import org.gfs.chat.backup.v2.proto.ChatItem
import org.gfs.chat.backup.v2.proto.ChatUpdateMessage
import org.gfs.chat.backup.v2.proto.ContactAttachment
import org.gfs.chat.backup.v2.proto.ContactMessage
import org.gfs.chat.backup.v2.proto.ExpirationTimerChatUpdate
import org.gfs.chat.backup.v2.proto.FilePointer
import org.gfs.chat.backup.v2.proto.GroupCall
import org.gfs.chat.backup.v2.proto.IndividualCall
import org.gfs.chat.backup.v2.proto.LearnedProfileChatUpdate
import org.gfs.chat.backup.v2.proto.MessageAttachment
import org.gfs.chat.backup.v2.proto.PaymentNotification
import org.gfs.chat.backup.v2.proto.ProfileChangeChatUpdate
import org.gfs.chat.backup.v2.proto.Quote
import org.gfs.chat.backup.v2.proto.Reaction
import org.gfs.chat.backup.v2.proto.RemoteDeletedMessage
import org.gfs.chat.backup.v2.proto.SendStatus
import org.gfs.chat.backup.v2.proto.SessionSwitchoverChatUpdate
import org.gfs.chat.backup.v2.proto.SimpleChatUpdate
import org.gfs.chat.backup.v2.proto.StandardMessage
import org.gfs.chat.backup.v2.proto.Sticker
import org.gfs.chat.backup.v2.proto.StickerMessage
import org.gfs.chat.backup.v2.proto.Text
import org.gfs.chat.backup.v2.proto.ThreadMergeChatUpdate
import org.gfs.chat.contactshare.Contact
import org.gfs.chat.database.AttachmentTable
import org.gfs.chat.database.CallTable
import org.gfs.chat.database.GroupReceiptTable
import org.gfs.chat.database.MessageTable
import org.gfs.chat.database.MessageTypes
...
import org.gfs.chat.database.model.GroupsV2UpdateMessageConverter
...
import org.gfs.chat.payments.FailureReason
import org.gfs.chat.payments.State
...
import org.gfs.chat.backup.v2.proto.BodyRange as BackupBodyRange
import org.gfs.chat.backup.v2.proto.GiftBadge as BackupGiftBadge
...
class ChatItemExportIterator(private val cursor: Cursor, private val batchSize: Int, private val archiveMedia: Boolean) : Iterator<ChatItem?>, Closeable {
  ...
  private fun LinkPreview.toBackupLinkPreview(): org.gfs.chat.backup.v2.proto.LinkPreview {
    return org.gfs.chat.backup.v2.proto.LinkPreview(
      url = url,
      title = title,
