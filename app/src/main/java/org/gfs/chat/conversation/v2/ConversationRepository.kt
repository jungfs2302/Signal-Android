...
import org.gfs.chat.ShortcutLauncherActivity
import org.gfs.chat.attachments.TombstoneAttachment
import org.gfs.chat.avatar.fallback.FallbackAvatarDrawable
import org.gfs.chat.components.emoji.EmojiStrings
import org.gfs.chat.components.reminder.BubbleOptOutReminder
import org.gfs.chat.components.reminder.ExpiredBuildReminder
import org.gfs.chat.components.reminder.GroupsV1MigrationSuggestionsReminder
import org.gfs.chat.components.reminder.PendingGroupJoinRequestsReminder
...
import org.gfs.chat.conversation.v2.RequestReviewState.GroupReviewState
import org.gfs.chat.conversation.v2.RequestReviewState.IndividualReviewState
import org.gfs.chat.conversation.v2.data.ConversationDataSource
...
import org.gfs.chat.jobs.MultiDeviceViewOnceOpenJob
...
import org.gfs.chat.messagerequests.MessageRequestState
...
import org.gfs.chat.profiles.spoofing.ReviewRecipient
...
import org.gfs.chat.util.MessageUtil
import org.gfs.chat.util.SignalLocalMetrics
import org.gfs.chat.util.Util
import org.gfs.chat.util.hasLinkPreview
import org.gfs.chat.util.hasSharedContact
import org.gfs.chat.util.hasTextSlide
import org.gfs.chat.util.isViewOnceMessage
import org.gfs.chat.util.requireTextSlide
...
class ConversationRepository(
  ...
  private val oldConversationRepository = org.gfs.chat.conversation.ConversationRepository()
