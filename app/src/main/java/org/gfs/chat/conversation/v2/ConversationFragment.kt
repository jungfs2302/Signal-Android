...
import org.gfs.chat.BlockUnblockDialog
import org.gfs.chat.GroupMembersDialog
import org.gfs.chat.LoggingFragment
import org.gfs.chat.MainActivity
import org.gfs.chat.MuteDialog
import org.gfs.chat.R
import org.gfs.chat.audio.AudioRecorder
import org.gfs.chat.badges.gifts.OpenableGift
import org.gfs.chat.badges.gifts.OpenableGiftItemDecoration
import org.gfs.chat.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import org.gfs.chat.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import org.gfs.chat.components.AnimatingToggle
import org.gfs.chat.components.ComposeText
import org.gfs.chat.components.ConversationSearchBottomBar
import org.gfs.chat.components.DeleteSyncEducationDialog
import org.gfs.chat.components.HidingLinearLayout
import org.gfs.chat.components.InputAwareConstraintLayout
import org.gfs.chat.components.InputPanel
import org.gfs.chat.components.InsetAwareConstraintLayout
import org.gfs.chat.components.ProgressCardDialogFragment
import org.gfs.chat.components.ProgressCardDialogFragmentArgs
import org.gfs.chat.components.ScrollToPositionDelegate
import org.gfs.chat.components.SendButton
import org.gfs.chat.components.ViewBinderDelegate
import org.gfs.chat.components.emoji.EmojiEventListener
import org.gfs.chat.components.emoji.MediaKeyboard
import org.gfs.chat.components.emoji.RecentEmojiPageModel
import org.gfs.chat.components.location.SignalPlace
import org.gfs.chat.components.mention.MentionAnnotation
import org.gfs.chat.components.menu.ActionItem
import org.gfs.chat.components.menu.SignalBottomActionBar
import org.gfs.chat.components.settings.app.subscription.donate.CheckoutFlowActivity
import org.gfs.chat.components.settings.app.subscription.donate.DonateToSignalFragment
import org.gfs.chat.components.settings.conversation.ConversationSettingsActivity
import org.gfs.chat.components.spoiler.SpoilerAnnotation
import org.gfs.chat.components.voice.VoiceNoteDraft
...
import org.gfs.chat.components.voice.VoiceNotePlayerView
import org.gfs.chat.contacts.paged.ContactSearchKey.RecipientSearchKey
import org.gfs.chat.contactshare.Contact
import org.gfs.chat.contactshare.ContactUtil
import org.gfs.chat.contactshare.SharedContactDetailsActivity
import org.gfs.chat.conversation.AttachmentKeyboardButton
import org.gfs.chat.conversation.BadDecryptLearnMoreDialog
...
import org.gfs.chat.conversation.ConversationHeaderView
import org.gfs.chat.conversation.ConversationIntents
import org.gfs.chat.conversation.ConversationIntents.ConversationScreenType
import org.gfs.chat.conversation.ConversationItem
import org.gfs.chat.conversation.ConversationItemSelection
import org.gfs.chat.conversation.ConversationItemSwipeCallback
import org.gfs.chat.conversation.ConversationMessage
import org.gfs.chat.conversation.ConversationOptionsMenu
import org.gfs.chat.conversation.ConversationReactionDelegate
import org.gfs.chat.conversation.ConversationReactionOverlay
import org.gfs.chat.conversation.ConversationReactionOverlay.OnActionSelectedListener
import org.gfs.chat.conversation.ConversationReactionOverlay.OnHideListener
import org.gfs.chat.conversation.ConversationSearchViewModel
import org.gfs.chat.conversation.ConversationUpdateTick
import org.gfs.chat.conversation.MarkReadHelper
import org.gfs.chat.conversation.MenuState
import org.gfs.chat.conversation.MessageSendType
import org.gfs.chat.conversation.MessageStyler.getStyling
import org.gfs.chat.conversation.ReenableScheduledMessagesDialogFragment
import org.gfs.chat.conversation.ScheduleMessageContextMenu
import org.gfs.chat.conversation.ScheduleMessageDialogCallback
import org.gfs.chat.conversation.ScheduleMessageTimePickerBottomSheet
import org.gfs.chat.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import org.gfs.chat.conversation.ScheduledMessagesBottomSheet
import org.gfs.chat.conversation.ScheduledMessagesRepository
import org.gfs.chat.conversation.SelectedConversationModel
import org.gfs.chat.conversation.ShowAdminsBottomSheetDialog
...
import org.gfs.chat.conversation.drafts.DraftRepository
import org.gfs.chat.conversation.drafts.DraftRepository.ShareOrDraftData
import org.gfs.chat.conversation.drafts.DraftViewModel
import org.gfs.chat.conversation.mutiselect.ConversationItemAnimator
import org.gfs.chat.conversation.mutiselect.MultiselectItemDecoration
import org.gfs.chat.conversation.mutiselect.MultiselectPart
import org.gfs.chat.conversation.mutiselect.forward.MultiselectForwardBottomSheet
...
import org.gfs.chat.conversation.quotes.MessageQuotesBottomSheet
import org.gfs.chat.conversation.ui.edit.EditMessageHistoryDialog
import org.gfs.chat.conversation.ui.error.EnableCallNotificationSettingsDialog
import org.gfs.chat.conversation.ui.inlinequery.InlineQuery
import org.gfs.chat.conversation.ui.inlinequery.InlineQueryChangedListener
import org.gfs.chat.conversation.ui.inlinequery.InlineQueryReplacement
import org.gfs.chat.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import org.gfs.chat.conversation.ui.inlinequery.InlineQueryViewModelV2
import org.gfs.chat.conversation.v2.computed.ConversationMessageComputeWorkers
import org.gfs.chat.conversation.v2.data.ConversationMessageElement
import org.gfs.chat.conversation.v2.groups.ConversationGroupCallViewModel
import org.gfs.chat.conversation.v2.groups.ConversationGroupViewModel
import org.gfs.chat.conversation.v2.items.ChatColorsDrawable
import org.gfs.chat.conversation.v2.items.InteractiveConversationElement
import org.gfs.chat.conversation.v2.keyboard.AttachmentKeyboardFragment
import org.gfs.chat.database.DraftTable
...
import org.gfs.chat.database.model.Quote
import org.gfs.chat.database.model.StickerRecord
import org.gfs.chat.database.model.databaseprotos.BodyRangeList
import org.gfs.chat.databinding.V2ConversationFragmentBinding
import org.gfs.chat.dependencies.AppDependencies
import org.gfs.chat.events.GroupCallPeekEvent
import org.gfs.chat.events.ReminderUpdateEvent
...
import org.gfs.chat.groups.ui.GroupErrors
import org.gfs.chat.groups.ui.LeaveGroupDialog
import org.gfs.chat.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import org.gfs.chat.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import org.gfs.chat.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import org.gfs.chat.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import org.gfs.chat.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
import org.gfs.chat.groups.v2.GroupBlockJoinRequestResult
import org.gfs.chat.invites.InviteActions
import org.gfs.chat.keyboard.KeyboardPage
import org.gfs.chat.keyboard.KeyboardPagerFragment
import org.gfs.chat.keyboard.KeyboardPagerViewModel
import org.gfs.chat.keyboard.KeyboardUtil
import org.gfs.chat.keyboard.emoji.EmojiKeyboardPageFragment
import org.gfs.chat.keyboard.emoji.search.EmojiSearchFragment
import org.gfs.chat.keyboard.gif.GifKeyboardPageFragment
import org.gfs.chat.keyboard.sticker.StickerKeyboardPageFragment
import org.gfs.chat.keyboard.sticker.StickerSearchDialogFragment
import org.gfs.chat.keyvalue.SignalStore
import org.gfs.chat.linkpreview.LinkPreview
import org.gfs.chat.linkpreview.LinkPreviewViewModelV2
import org.gfs.chat.longmessage.LongMessageFragment
import org.gfs.chat.mediaoverview.MediaOverviewActivity
import org.gfs.chat.mediapreview.MediaIntentFactory
import org.gfs.chat.mediapreview.MediaPreviewV2Activity
import org.gfs.chat.mediasend.Media
import org.gfs.chat.mediasend.MediaSendActivityResult
import org.gfs.chat.messagedetails.MessageDetailsFragment
import org.gfs.chat.messagerequests.MessageRequestRepository
import org.gfs.chat.mms.AttachmentManager
import org.gfs.chat.mms.AudioSlide
import org.gfs.chat.mms.DocumentSlide
import org.gfs.chat.mms.GifSlide
import org.gfs.chat.mms.ImageSlide
import org.gfs.chat.mms.MediaConstraints
import org.gfs.chat.mms.QuoteModel
import org.gfs.chat.mms.Slide
import org.gfs.chat.mms.SlideDeck
import org.gfs.chat.mms.SlideFactory
import org.gfs.chat.mms.StickerSlide
import org.gfs.chat.mms.VideoSlide
import org.gfs.chat.nicknames.NicknameActivity
import org.gfs.chat.notifications.v2.ConversationId
import org.gfs.chat.payments.preferences.PaymentsActivity
import org.gfs.chat.permissions.Permissions
import org.gfs.chat.profiles.manage.EditProfileActivity
import org.gfs.chat.profiles.spoofing.ReviewCardDialogFragment
import org.gfs.chat.providers.BlobProvider
import org.gfs.chat.ratelimit.RecaptchaProofBottomSheetFragment
import org.gfs.chat.ratelimit.RecaptchaRequiredEvent
import org.gfs.chat.reactions.ReactionsBottomSheetDialogFragment
import org.gfs.chat.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment
...
import org.gfs.chat.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import org.gfs.chat.registration.ui.RegistrationActivity
import org.gfs.chat.revealable.ViewOnceMessageActivity
import org.gfs.chat.revealable.ViewOnceUtil
import org.gfs.chat.safety.SafetyNumberBottomSheet
import org.gfs.chat.sms.MessageSender
import org.gfs.chat.stickers.StickerEventListener
import org.gfs.chat.stickers.StickerLocator
import org.gfs.chat.stickers.StickerManagementActivity
import org.gfs.chat.stickers.StickerPackInstallEvent
import org.gfs.chat.stickers.StickerPackPreviewActivity
...
import org.gfs.chat.util.BubbleUtil
...
import org.gfs.chat.util.DeleteDialog
import org.gfs.chat.util.Dialogs
import org.gfs.chat.util.DoubleClickDebouncer
import org.gfs.chat.util.DrawableUtil
import org.gfs.chat.util.FullscreenHelper
import org.gfs.chat.util.MediaUtil
import org.gfs.chat.util.MessageConstraintsUtil
import org.gfs.chat.util.MessageConstraintsUtil.getEditMessageThresholdHours
import org.gfs.chat.util.MessageConstraintsUtil.isValidEditMessageSend
import org.gfs.chat.util.PlayStoreUtil
import org.gfs.chat.util.RemoteConfig
import org.gfs.chat.util.SaveAttachmentUtil
import org.gfs.chat.util.SignalLocalMetrics
import org.gfs.chat.util.StorageUtil
import org.gfs.chat.util.TextSecurePreferences
import org.gfs.chat.util.ViewUtil
import org.gfs.chat.util.WindowUtil
import org.gfs.chat.util.atMidnight
import org.gfs.chat.util.atUTC
import org.gfs.chat.util.createActivityViewModel
import org.gfs.chat.util.doAfterNextLayout
import org.gfs.chat.util.fragments.requireListener
import org.gfs.chat.util.getRecordQuoteType
import org.gfs.chat.util.hasAudio
import org.gfs.chat.util.hasGiftBadge
import org.gfs.chat.util.hasNonTextSlide
import org.gfs.chat.util.isValidReactionTarget
import org.gfs.chat.util.padding
import org.gfs.chat.util.savedStateViewModel
import org.gfs.chat.util.setIncognitoKeyboardEnabled
import org.gfs.chat.util.toMillis
import org.gfs.chat.util.viewModel
import org.gfs.chat.util.views.Stub
import org.gfs.chat.util.visible
import org.gfs.chat.verify.VerifyIdentityActivity
import org.gfs.chat.wallpaper.ChatWallpaper
import org.gfs.chat.wallpaper.ChatWallpaperDimLevelUtil
