...
import org.gfs.chat.jobs.UnableToStartException
import org.gfs.chat.recipients.Recipient
import org.gfs.chat.recipients.RecipientId
import org.gfs.chat.service.SafeForegroundService
import org.gfs.chat.util.TelephonyUtil
import org.gfs.chat.webrtc.CallNotificationBuilder
import org.gfs.chat.webrtc.UncaughtExceptionHandlerManager
import org.gfs.chat.webrtc.audio.AudioManagerCommand
import org.gfs.chat.webrtc.audio.SignalAudioManager
import org.gfs.chat.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "org.gfs.chat.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "org.gfs.chat.service.webrtc.ActiveCallAction.HANGUP"
    }
