...
import org.gfs.chat.util.safeUnregisterReceiver
import org.gfs.chat.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [org.gfs.chat.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [org.gfs.chat.webrtc.audio.SignalAudioManager].
 */
