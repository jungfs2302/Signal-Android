...
import org.gfs.chat.avatar.AvatarBundler
import org.gfs.chat.avatar.photo.PhotoEditorActivity
import org.gfs.chat.avatar.photo.PhotoEditorFragment
import org.gfs.chat.avatar.text.TextAvatarCreationFragment
import org.gfs.chat.avatar.vector.VectorAvatarCreationFragment
import org.gfs.chat.components.ButtonStripItemView
import org.gfs.chat.components.recyclerview.GridDividerDecoration
import org.gfs.chat.groups.ParcelableGroupId
import org.gfs.chat.mediasend.AvatarSelectionActivity
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "org.gfs.chat.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "org.gfs.chat.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "org.gfs.chat.avatar.picker.SELECT_AVATAR_CLEAR"
