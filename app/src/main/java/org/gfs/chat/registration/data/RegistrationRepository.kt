...
package org.gfs.chat.registration.data
...
import org.gfs.chat.gcm.FcmUtil
...
import org.gfs.chat.pin.Svr3Migration
...
import org.gfs.chat.registration.PushChallengeRequest
import org.gfs.chat.registration.RegistrationData
import org.gfs.chat.registration.VerifyAccountRepository
import org.gfs.chat.registration.data.LocalRegistrationMetadataUtil.getAciPreKeyCollection
import org.gfs.chat.registration.data.LocalRegistrationMetadataUtil.getPniPreKeyCollection
...
object RegistrationRepository {
  ...
  suspend fun registerAccount(context: Context, sessionId: String?, registrationData: RegistrationData, pin: String? = null, masterKeyProducer: VerifyAccountRepository.MasterKeyProducer? = null): RegisterAccountResult =
    withContext(Dispatchers.IO) {
      ...
      val aciPreKeyCollection = org.gfs.chat.registration.RegistrationRepository.generateSignedAndLastResortPreKeys(aciIdentity, SignalStore.account.aciPreKeys)
      val pniPreKeyCollection = org.gfs.chat.registration.RegistrationRepository.generateSignedAndLastResortPreKeys(pniIdentity, SignalStore.account.pniPreKeys)
