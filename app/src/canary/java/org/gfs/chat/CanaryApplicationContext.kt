  ...
  override fun onCreate() {
    ...
    LeakCanary.config = LeakCanary.config.copy(
      referenceMatchers = AndroidReferenceMatchers.appDefaults +
        ...
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.gfs.chat.components.voice.VoiceNotePlaybackService",
          fieldName = "mApplication"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.gfs.chat.service.GenericForegroundService\$LocalBinder",
          fieldName = "this\$0"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.gfs.chat.contacts.ContactsSyncAdapter",
          fieldName = "mContext"
        )
    )
  }
