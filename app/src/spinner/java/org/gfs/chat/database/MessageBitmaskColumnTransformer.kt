...
import org.gfs.chat.database.MessageTypes.BAD_DECRYPT_TYPE
import org.gfs.chat.database.MessageTypes.BASE_DRAFT_TYPE
import org.gfs.chat.database.MessageTypes.BASE_INBOX_TYPE
import org.gfs.chat.database.MessageTypes.BASE_OUTBOX_TYPE
import org.gfs.chat.database.MessageTypes.BASE_PENDING_INSECURE_SMS_FALLBACK
import org.gfs.chat.database.MessageTypes.BASE_PENDING_SECURE_SMS_FALLBACK
import org.gfs.chat.database.MessageTypes.BASE_SENDING_TYPE
import org.gfs.chat.database.MessageTypes.BASE_SENT_FAILED_TYPE
import org.gfs.chat.database.MessageTypes.BASE_SENT_TYPE
import org.gfs.chat.database.MessageTypes.BASE_TYPE_MASK
import org.gfs.chat.database.MessageTypes.CHANGE_NUMBER_TYPE
import org.gfs.chat.database.MessageTypes.ENCRYPTION_REMOTE_BIT
import org.gfs.chat.database.MessageTypes.ENCRYPTION_REMOTE_DUPLICATE_BIT
import org.gfs.chat.database.MessageTypes.ENCRYPTION_REMOTE_FAILED_BIT
import org.gfs.chat.database.MessageTypes.ENCRYPTION_REMOTE_LEGACY_BIT
import org.gfs.chat.database.MessageTypes.ENCRYPTION_REMOTE_NO_SESSION_BIT
import org.gfs.chat.database.MessageTypes.END_SESSION_BIT
import org.gfs.chat.database.MessageTypes.EXPIRATION_TIMER_UPDATE_BIT
import org.gfs.chat.database.MessageTypes.GROUP_CALL_TYPE
import org.gfs.chat.database.MessageTypes.GROUP_LEAVE_BIT
import org.gfs.chat.database.MessageTypes.GROUP_UPDATE_BIT
import org.gfs.chat.database.MessageTypes.GROUP_V2_BIT
import org.gfs.chat.database.MessageTypes.GROUP_V2_LEAVE_BITS
import org.gfs.chat.database.MessageTypes.GV1_MIGRATION_TYPE
import org.gfs.chat.database.MessageTypes.INCOMING_AUDIO_CALL_TYPE
import org.gfs.chat.database.MessageTypes.INCOMING_VIDEO_CALL_TYPE
import org.gfs.chat.database.MessageTypes.INVALID_MESSAGE_TYPE
import org.gfs.chat.database.MessageTypes.JOINED_TYPE
import org.gfs.chat.database.MessageTypes.KEY_EXCHANGE_BIT
import org.gfs.chat.database.MessageTypes.KEY_EXCHANGE_BUNDLE_BIT
import org.gfs.chat.database.MessageTypes.KEY_EXCHANGE_IDENTITY_DEFAULT_BIT
import org.gfs.chat.database.MessageTypes.KEY_EXCHANGE_IDENTITY_UPDATE_BIT
import org.gfs.chat.database.MessageTypes.KEY_EXCHANGE_IDENTITY_VERIFIED_BIT
import org.gfs.chat.database.MessageTypes.KEY_EXCHANGE_INVALID_VERSION_BIT
import org.gfs.chat.database.MessageTypes.MESSAGE_FORCE_SMS_BIT
import org.gfs.chat.database.MessageTypes.MESSAGE_RATE_LIMITED_BIT
import org.gfs.chat.database.MessageTypes.MISSED_AUDIO_CALL_TYPE
import org.gfs.chat.database.MessageTypes.MISSED_VIDEO_CALL_TYPE
import org.gfs.chat.database.MessageTypes.OUTGOING_AUDIO_CALL_TYPE
import org.gfs.chat.database.MessageTypes.OUTGOING_MESSAGE_TYPES
import org.gfs.chat.database.MessageTypes.OUTGOING_VIDEO_CALL_TYPE
import org.gfs.chat.database.MessageTypes.PROFILE_CHANGE_TYPE
import org.gfs.chat.database.MessageTypes.PUSH_MESSAGE_BIT
import org.gfs.chat.database.MessageTypes.RELEASE_CHANNEL_DONATION_REQUEST_TYPE
import org.gfs.chat.database.MessageTypes.SECURE_MESSAGE_BIT
import org.gfs.chat.database.MessageTypes.SMS_EXPORT_TYPE
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPES_MASK
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_GIFT_BADGE
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_MESSAGE_REQUEST_ACCEPTED
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_PAYMENTS_ACTIVATED
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_PAYMENTS_ACTIVATE_REQUEST
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_PAYMENTS_NOTIFICATION
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_REPORTED_SPAM
import org.gfs.chat.database.MessageTypes.SPECIAL_TYPE_STORY_REACTION
import org.gfs.chat.database.MessageTypes.THREAD_MERGE_TYPE
import org.gfs.chat.database.MessageTypes.UNSUPPORTED_MESSAGE_TYPE
